export class Post {
  ...
  addComment(e) {
    ...
    document
      .getElementById(`post_${this.id}`)
      .querySelector(".all_comments").innerHTML += commentTemplate;
    document
      .getElementById(`post_${this.id}`)
      .querySelector(".comments_text").innerHTML = `All comments (${
  ...
  showAllComments() {
    if (this.showComments) {
      document
        .getElementById(`post_${this.id}`)
        .querySelector(".all_comments").innerHTML = "";
      this.showComments = false;
    } else {
      ...
      document
        .getElementById(`post_${this.id}`)
        .querySelector(".all_comments").innerHTML = newArrComm.join("\n");
      document
        .getElementById(`post_${this.id}`)
        .querySelector(".comments_text").innerHTML = `All comments (${
        this.comments.length
    ...
    div.innerHTML = `
        <div class="post" id="post_${this.id}">
            ...
            <div class="header_post">
                ...
                <div class="wrap_date_name">
                    <span class="user_name">${this.author.firstName} ${
      this.author.lastName
            ...
            <div class="footer_post">
                <span class="comments_text">All comments (${
                  this.comments.length
                })</span>
                ...
                ${
                  currentUser !== null
                    ? `<form class="comment_form">
                                <input hidden name="user_name" value="${
                                  currentUser.name
                                } ${currentUser.last}"/>
